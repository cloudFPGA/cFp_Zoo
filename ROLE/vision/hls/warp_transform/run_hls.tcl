...
# ------------------------------------------------------------------------------
set projectName    "warp_transform"
set solutionName   "solution1"
set xilPartName    "xcku060-ffva1156-2-i"

set ipName         ${projectName}
set ipDisplayName  "WarpTransform Application Example."
...
set_top       ${projectName}
#set_top cornerWarpTransformAccelMem
...
add_files     ${srcDir}/xf_warp_transform_accel.cpp -cflags "-I$env(cFpRootDir)/cFDK/SRA/LIB/hls ${VISION_INC_FLAGS} ${vitis_flags}" -csimflags "-I$env(cFpRootDir)/cFDK/SRA/LIB/hls ${VISION_INC_FLAGS} ${vitis_flags}"
