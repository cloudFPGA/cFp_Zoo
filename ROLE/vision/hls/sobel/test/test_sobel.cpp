...
int main(int argc, char** argv) {
    ...
    //------------------------------------------------------
    //-- TESTBENCH LOCAL VARIABLES FOR SOBEL
    //------------------------------------------------------
    ...
    while (tb_trials++ < TB_TRIALS) {
        ...
        //------------------------------------------------------
        //-- STEP-1.2 : RUN SOBEL DETECTOR FROM OpenCV LIBRARY
        //------------------------------------------------------
...
if (simCnt < 0)
    ...
    // L1 Vitis Sobel 
    //sobel_accel(imgInput, imgOutput, Thresh, k);
	
    #endif

    #if RO

    sobel_accel(imgInput, imgOutputTb);
    ...
    // &imgOutput   : The processed image by Sobel IP inside the ROLE (i.e. I/O traffic is passing through SHELL)
    // &imgOutputTb : The processed image by Sobel IP in this testbench (i.e. I/O traffic is done in testbench)
