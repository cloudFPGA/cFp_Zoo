 ...
 * @brief      The Gammacorrection configuration header
 * @author     DID
 * @date       May 2020
 * 
 * @ingroup Gammacorrection
 * @addtogroup Gammacorrection
 * \{
 *****************************************************************************/


#ifndef _XF_GAMMACORRECTION_CONFIG_H_
#define _XF_GAMMACORRECTION_CONFIG_H_

#include "hls_stream.h"
#include "ap_int.h"
#include "common/xf_common.hpp"
#include "common/xf_utility.hpp"
#include "features/xf_gammacorrection.hpp"
...
void gammacorrection_accel(xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPIX>& _src,
                  xf::cv::Mat<XF_8UC1, HEIGHT, WIDTH, NPIX>& _dst,
                  unsigned short Thresh,
                  unsigned short k);

void cornerGammacorrectionAccelArray(ap_uint<INPUT_PTR_WIDTH>* img_inp,
