...
# *  Did: Apr-22-2020 Added xf:cv:median_blur example from Xilinx Vitis
# ******************************************************************************

# ------------------------------------------------------------------------------
# User defined settings
# ------------------------------------------------------------------------------
set projectName    "median_blur"
set solutionName   "solution1"
set xilPartName    "xcku060-ffva1156-2-i"

set ipName         ${projectName}
set ipDisplayName  "MedianBlur Application Example."
...
set_top       ${projectName}
#set_top cornerMedianBlurAccelMem
#set_top median_blur_accel
...
add_files     ${srcDir}/xf_median_blur_accel.cpp -cflags "-I$env(cFpRootDir)/cFDK/SRA/LIB/hls ${VISION_INC_FLAGS} ${vitis_flags}" -csimflags "-I$env(cFpRootDir)/cFDK/SRA/LIB/hls ${VISION_INC_FLAGS} ${vitis_flags}"
