...
# @brief  A script for editing the files needed to select the cFp_Zoo kernel to be implemented
# @author DID
# @date Nov. 2020
...
kernels = ["Harris", "Median_Blur", "MCEuropeanEngine", "Uppercase", "Memtest", "Warp_Transform"]
