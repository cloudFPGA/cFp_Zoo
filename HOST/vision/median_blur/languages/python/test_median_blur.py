...
trieres_lib=os.environ['cFpRootDir'] + "HOST/"
sys.path.append(trieres_lib)

from trieres import vision
...
#for i in range(100):
    ...
    output_array = vision.median_blur(input_array, total_size, "10.12.200.9", 2718, logging.ERROR)
