...
#for i in range(100):
    ...
    #output_array = _trieres_median_blur_numpi.median_blur(input_array, total_size, "10.12.200.73", "2718")
    output_array = trieres.vision.median_blur(input_array, total_size, "10.12.200.73", 2718)
