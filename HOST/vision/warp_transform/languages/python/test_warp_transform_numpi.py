...
## @file   test_warp_transform_numpi.py
## @author DID
## @date   November 2020
...
# path  
image_in_filename = os.environ['cFpRootDir'] + "ROLE/vision/hls/warp_transform/test/512x512.png"
...
#for i in range(100):
    ...
    output_array = _trieres_warp_transform_numpi.warp_transform(input_array, total_size, "10.12.200.122", "2718")
