 ...
 * @brief      Gammacorrection userspace application for cF (x86, ppc64).
 *
 * @date       May 2020
 * @author     DID
 * 
...
#include "../../../../ROLE/vision/hls/gammacorrection/include/xf_ocv_ref.hpp"  // For SW reference Gammacorrection from OpenCV
...
void print_cFpZoo(void)
{
	...
	cout <<  "Gamma correction filter                                   " << endl;
}


/*****************************************************************************
 * @brief Mark the points found by Gammacorrection into the image.
 * 
 * @return Nothing
 ******************************************************************************/
