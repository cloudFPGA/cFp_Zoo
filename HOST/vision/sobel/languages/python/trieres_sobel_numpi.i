/* trieres_sobel_numpi.i */

%module trieres_sobel_numpi
...
extern void sobel(int total_size, unsigned char *input_img, int total_size2, unsigned char *output_img, char *s_servAddress, char *s_servPort);
%}
