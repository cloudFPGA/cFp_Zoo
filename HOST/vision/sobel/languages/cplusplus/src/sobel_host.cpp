...
/*****************************************************************************
 * @file       sobel_host.cpp
 * @brief      Sobel userspace application for cF (x86, ppc64).
 *
 * @date       May 2020
 * @author     DID
 * 
...
#if !defined(PY_WRAP) || (PY_WRAP == PY_WRAP_SOBEL_FILENAME) || (PY_WRAP == PY_WRAP_SOBEL_NUMPI)
#include "opencv2/opencv.hpp"
#include "../../../../../../ROLE/vision/hls/sobel/include/xf_ocv_ref.hpp"  // For SW reference Sobel from OpenCV
using namespace cv;
#endif
...
void sobel(char *s_servAddress, char *s_servPort, char *input_str, char *output_img_str, char *output_points_str)
#elif PY_WRAP == PY_WRAP_SOBEL_NUMPI
void sobel(int total_size, unsigned char *input_img, int total_size2, unsigned char *output_img, char *s_servAddress, char *s_servPort)
#endif // PY_WRAP value
{
#else // !PY_WRAP
  /**
