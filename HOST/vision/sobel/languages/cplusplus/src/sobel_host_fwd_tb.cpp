...
/*****************************************************************************
 * @file       sobel_host_fwd_tb.cpp
 * @brief      Testbench for Sobel userspace application for cF (x86, ppc64).
 *
 * @date       May 2020
 * @author     DID
 * 
...
using namespace cv;
  ...
  /**
   *   Main testbench for the user-application for Sobel on host. Server
...
int main(int argc, char * argv[]) {
	...
	cout << endl;
	    ...
	    // We save the image received from network in order to process it with the sobel HLS TB
	    imwrite("../../../../../../ROLE/vision/hls/sobel/test/input_from_udp_to_fpga.png", frame);
	    
	    // Select simulation mode, default fcsim
	    string synth_cmd = " ";
	    string exec_cmd = "make fcsim -j 4";
	    string ouf_file = "../../../../../../ROLE/vision/hls/sobel/sobel_prj/solution1/fcsim/build/hls_out.jpg";
	    if (argc == 3) {
	      if (atoi(argv[2]) == 2) {
		exec_cmd = "make csim";
		ouf_file = "../../../../../../ROLE/vision/hls/sobel/sobel_prj/solution1/csim/build/hls_out.jpg";
	      }
	      else if (atoi(argv[2]) == 3) {
		synth_cmd = "make csynth && ";
		exec_cmd = "make cosim";
		ouf_file = "../../../../../../ROLE/vision/hls/sobel/sobel_prj/solution1/sim/wrapc_pc/hls_out.jpg";
	      }
	      else if (atoi(argv[2]) == 4) {
		exec_cmd = "make kcachegrind";
		ouf_file = "../../../../../../ROLE/vision/hls/sobel/sobel_prj/solution1/fcsim/build/hls_out.jpg";
	      }
	    }
	    ...
	    string str_command = "cd ../../../../../../ROLE/vision/hls/sobel/ && " + clean_cmd + synth_cmd + "\
				  INPUT_IMAGE=./test/input_from_udp_to_fpga.png " + exec_cmd + " && \
				  cd ../../../../HOST/vision/sobel/languages/cplusplus/build/ "; 
